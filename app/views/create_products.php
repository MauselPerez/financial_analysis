                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title" style="color: red;">Crear Producto</h6>
                        </div>
                        <div class="card-body">
                            <form action="../../app/controllers/controller_products.php?action=createProduct" method="POST" id="frm_create_user" name="frm_create_user">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="txt_refer">Producto</label>
                                                <input type="text" class="form-control" id="txt_name" name="txt_name" placeholder="Producto" require>
                                            </div> 
                                        </div>  
                                    </div>  
                                </div>
                                <div class="card-footer">
                                    <button type="submit" id="btn_create_product" name="btn_create_product" class="btn btn-success"><i class="nav-icon fas fa-hamburger"></i> Crear</button>
